...
\kappa((\mathbf{I} + 50 \mathbf{L})^{-1})$ is not EDM-2.
\begin{figure}[hbtp]
  \centering
...
\beta/\mathrm{Vol}(G)$. Proposition \ref{prop:21} and Proposition
\ref{prop:22} combined to give a generalization of Theorem \ref{thm:4}
to general graphs. 
