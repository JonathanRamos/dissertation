...
\bm{\nu}_2, \dots, \bm{nu}_N$ are the corresponding eigenvectors, then the
...
% 
%
\noindent Another embedding of $\Delta_\delta$ can be found by using the
eigenvalues and eigenvectors of $\mathbf{P}$. Note that
$\mathbf{P} - \mathbf{Q}$ has the same eigenvalues and eigenvectors as
$\mathbf{P}$, except that the eigenvalue $1$ of $\mathbf{P}$ is
replaced by the eigenvalue $0$ of $\mathbf{P} -
\mathbf{Q}$. Furthermore, the spectral radius of $\mathbf{P} -
\mathbf{Q}$ is less than $1$. That's to say,
\begin{equation}
  \label{eq:97}
