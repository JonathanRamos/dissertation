...
\begin{figure}[htbp]
  ...
  \subfigure[][]{
    ...
    \includegraphics[width=8cm]{graphics/dge/dge_toy1_projected.pdf}
  }
  \hspace{8pt}
  \subfigure[][]{
    \label{fig:toy1_separate}
    \includegraphics[width=8cm]{graphics/dge/dge_toy1_separate.pdf}
  }
...
\begin{figure}[htbp]
  \centering
    \includegraphics[width=14cm]{graphics/dge/dge_morsecode_bimension12.pdf}
