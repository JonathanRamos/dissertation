...
\bibitem{tenebaum00:_global_geomet_framew_nonlin_dimen_reduc}
J.~B. Tenenbaum et~al.
\newblock A global geometric framework for nonlinear dimensionality reduction.
\newblock {\em Science}, 290:2319--2323, December 2000.

\bibitem{roweis00:_nonlin}
...
\bibitem{pearson01:_on}
K.~Pearson.
\newblock On lines and planes of closest fit to a system of points in space.
\newblock {\em Philosophical Magazine}, 2:557--572, 1901.

\bibitem{hotelling33:_analy}
H.~Hotelling.
...
\bibitem{hastie&stuetzle:1989}
T.~Hastie and W.~Stuetzle.
\newblock Principal curves.
\newblock {\em Journal of the American Statistical Association}, 84:502--516,
  1989.

\bibitem{gower66:_some}
J.~C. Gower.
\newblock Some distance properties of latent root and vector methods used in
  multivariate analysis.
\newblock {\em Biometrika}, 53:325--338, 1966.

\bibitem{torgesen52:_multid}
W.~S. Torgesen.
\newblock Multidimensional scaling: {I}. {T}heory and method.
\newblock {\em Psychometrika}, 17:401--419, 1952.

\bibitem{belkin03:_laplac}
M.~Belkin and P.~Niyogi.
\newblock Laplacian eigenmaps for dimensionality reduction and data
  representation.
\newblock {\em Neural Computation}, 15:1373--1396, 2003.

\bibitem{coifman06:_diffus_maps}
R.~Coifman and S.~Lafon.
\newblock Diffusion maps.
\newblock {\em Applied and Computational Harmonic Analysis}, 21:5--30, 2006.

\bibitem{maier08:_influen}
...
\bibitem{yan07:_graph_embed_exten}
...
\bibitem{schoenberg35:_remar_mauric_frech_sur_hilber}
I.~Schoenberg.
...
\newblock {\em Annals of Mathematics}, 38:724--738, 1935.

\bibitem{critchley88:_certain_linear_mappin}
F.~Critchley.
\newblock On certain linear mappings between inner-product and squared-distance
  matrices.
\newblock {\em Linear Algebra and Its Applications}, 105:91--107, 1988.

\bibitem{doyle84:_random_walks_elect_networ}
P.G. Doyle and J.L. Snell.
\newblock {\em Random Walks and Electrical Networks}.
\newblock Mathematical Association of America, 1984.

\bibitem{lovasz96:_random_graph}
L.~Lov\'{a}sz.
\newblock Random walks on graphs: A survey.
\newblock {\em Bolyai Society Mathematical Studies}, 2:353--397, 1996.

\bibitem{levin09:_markov_chain_mixin_times}
...
\newblock The principal components analysis of a graph and its relationships to
  spectral clustering.
\newblock {\em Proceedings of the fifteenth {E}uropean conference on machine
  learning}, 2004.

\bibitem{yen07:_graph}
...
\bibitem{qui07:_clust}
H.~Qui and E.R. Hancock.
\newblock Clustering and embedding using commute times.
\newblock {\em IEEE transactions in Pattern Analysis and Machine Intelligence},
  29:1873--1890, 2007.

\bibitem{szummer01:_partial_markov}
M.~Szummer and T.~Jaakkola.
\newblock Partially labeled classification with markov random walks.
\newblock {\em Advances in Neural Information Processing System}, 2001.

\bibitem{zhou04:_learn}
D.~Zhou, T.~N. Lal, J.~Weston, and B.~Sch\"{o}lkopf.
\newblock Learning with local and global consistency.
\newblock {\em Advances in Neural Information Processing System}, 2004.

\bibitem{zhou04:_learn_label_unlab}
D.~Zhou and B.~Sch\"{o}lkopf.
\newblock Learning from labeled and unlabeled data using random walks.
\newblock {\em Proceedings of the twenty sixth DAGM Sympsium}, pages 237--244,
  2004.

\bibitem{zhu03:_semi_super_learn_using_gauss}
X.~Zhu, Z.~Ghahramani, and J.~Lafferty.
\newblock Semi-supervised learning using {G}aussian fields and harmonic
  functions.
\newblock {\em International Conference on Machine Learning}, 2003.

\bibitem{spielmand08:_graph}
...
\bibitem{kemeny83:_finit_markov_chain}
J.~G. Kemeny and J.~L. Snell.
\newblock {\em Finite Markov Chains}.
\newblock Springer, 1983.

\bibitem{bapat99:_resis_distan_in_graph}
R.B. Bapat.
\newblock Resistance distance in graphs.
\newblock {\em The Mathematics Student}, 68:87--98, 1999.

\bibitem{klein93:_resis_distan}
D.J. Klein and M.~Randic.
\newblock Resistance distance.
\newblock {\em Journal of Mathematical Chemistry}, 12:81--95, 1993.

\bibitem{horn90:_matrix_analy}
R.~Horn and C.~Johnson.
\newblock {\em Matrix Analysis}.
\newblock Cambridge University Press, 1990.

\bibitem{horn94:_topic_in_matrix_analy}
R.A. Horn and C.R. Johnson.
\newblock {\em Topics in Matrix Analysis}.
\newblock Cambridge University Press, 1994.

\bibitem{gamelin01:_compl_analy}
T.~W. Gamelin.
\newblock {\em Complex Analysis}.
\newblock Springer, 2001.

\bibitem{kondor02:_diffus}
...
\newblock Out-of-sample extensions for lle, {I}somap, mds, eigenmaps and
  spectral clustering.
\newblock {\em Advances in Neural Information Processing Systems}, 16, 2004.

\bibitem{rothkopf57}
E.~Z. Rothkopf.
\newblock A measure of stimulus similarity and errors in some paired associate
  learning.
\newblock {\em Journal of Experimental Psychology}, 53:94--101, 1957.

\bibitem{chung05:_laplac_cheeg}
F.~Chung.
\newblock Laplacians and the {C}heeger inequality for directed graphs.
\newblock {\em Annals of Combinatorics}, 9:1--19, 2005.

\bibitem{boley09:_gener_laplac}
D.~Boley.
...
\bibitem{johnson75:_power_matric_posit_defin_real_part}
C.~R. Johnson.
\newblock Powers of matrics with positive definite real part.
\newblock {\em Proceedings of the American Mathematical Society}, 50:85--91,
  1975.
