...
are grouped the umbrella of \emph{nonlinear} dimension reduction. For
...
\citet{hastie84:_princ} and \citet{hastie89:_princ}. Meanwhile extension of PCA
...
regularized principal manifold \citep{smola01:_regul_princ_manif} ,
...
example the book of \citet{cvetkovic80:_spect_graph_theor_applic} and the
survey articles of \citet{merris94:_laplac} and \citet{mohar91:_graph}. The
...
not discussed here, refer to the survey articles of
...
\S~\ref{sec:locally-line-embedd}. Hessian eigenmaps is motivated by
the assumption that the data points lies on a $d$-dimensional
...
Diffusion maps \citep{coifman06:_diffus_maps} is an embedding
...
step. The later chapters of this work are concerned with the
interplay between the second and third steps of the above
recipe. Chapter~\ref{cha:dist-undir-graphs} and
Chapter~\ref{cha:dist-direct-graphs} are devoted to discussing various
...
notions of graph metrics in Chapter~\ref{cha:graph-metr-dimens}. We will
see in Chapter~\ref{cha:graph-metr-dimens} that the embedding suggested by
...
expounded here. \citet{ham04} showed that several
