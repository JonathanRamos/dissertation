...
example \citet{cvetkovic80:_spect_graph_theor_applic,mohar91:_graph}
and the references within. The normalized Laplacian
$\bm{\mathcal{L}}(G)$ appeared mainly through the pioneering work done
by Chung and her coauthors. The monograph
...
analysis, and other diverse disciplines. Recently, Laplacians matrices
of graphs had appeared in spectral clustering, e.g.,
\citet{shi00:_normal}, and manifold learning, e.g.,
\citet{belkin03:_laplac}. Connections between the graph Laplacians and
the Laplace-Beltrami operator on Riemannian manifolds lead to the
